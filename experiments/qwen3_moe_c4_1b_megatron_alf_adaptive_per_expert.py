"""1B-parameter 24-expert Qwen-style MoE C4 ALF adaptive per-expert bias-update Megatron experiment."""
...
config = ExperimentConfig(
    name="qwen3_moe_c4_1b_megatron_alf_adaptive_per_expert",
    model=ModelConfig(
    ...
    training=TrainingConfig(
        output_dir="outputs/qwen3_moe_c4_1b_megatron_alf_adaptive_per_expert",
        seed=42,
        max_steps=100_000,
        batch_size=2,
    ...
    wandb=WandbConfig(
        ...
        tags=["alf", "adaptive-per-expert", "qwen3-moe", "c4", "1b", "24experts", "top3", "megatron", "ep4", "dp2"],
    ),
)
