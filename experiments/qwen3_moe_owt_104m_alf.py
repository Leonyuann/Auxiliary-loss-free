...
config = ExperimentConfig(
    ...
    training=TrainingConfig(
        output_dir="outputs/qwen3_moe_owt_104m_alf",
        seed=42,
        max_steps=10_000,
        batch_size=128,
    ...
    wandb=WandbConfig(
        ...
        tags=["alf", "proportional", "qwen3-moe", "owt", "104m", "4h", "bpe32k"],
    ),
)
