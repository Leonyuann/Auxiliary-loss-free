...
config = ExperimentConfig(
    ...
    training=TrainingConfig(
        output_dir="outputs/qwen3_moe_c4_300m_alf_adaptive_per_expert",
        seed=42,
        max_steps=20_000,
        batch_size=128,
