"""1B-parameter 24-expert Qwen-style MoE C4 ALF EMA bias-update Megatron experiment."""
...
config = ExperimentConfig(
    name="qwen3_moe_c4_1b_megatron_alf_ema",
    model=ModelConfig(
    ...
    training=TrainingConfig(
        output_dir="outputs/qwen3_moe_c4_1b_megatron_alf_ema",
        seed=42,
        max_steps=100_000,
        batch_size=2,
    ...
    wandb=WandbConfig(
        ...
        tags=["alf", "alf-ema", "qwen3-moe", "c4", "1b", "24experts", "top3", "megatron", "ep4", "dp2"],
    ),
)
