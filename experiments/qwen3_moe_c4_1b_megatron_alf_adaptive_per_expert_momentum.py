"""1B-parameter 24-expert Qwen-style MoE C4 ALF adaptive per-expert momentum bias-update Megatron experiment."""
...
config = ExperimentConfig(
    name="qwen3_moe_c4_1b_megatron_alf_adaptive_per_expert_momentum",
    model=ModelConfig(
    ...
    training=TrainingConfig(
        output_dir="outputs/qwen3_moe_c4_1b_megatron_alf_adaptive_per_expert_momentum",
        seed=42,
        max_steps=100_000,
        batch_size=2,
    ...
    alf=AlfConfig(
        ...
        bias_adaptive_per_expert_momentum_beta=0.6,
    ...
    wandb=WandbConfig(
        ...
        tags=["alf", "adaptive-per-expert-momentum", "qwen3-moe", "c4", "1b", "24experts", "top3", "megatron", "ep4", "dp2"],
    ),
)
