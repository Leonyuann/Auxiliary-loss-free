...
config = ExperimentConfig(
    ...
    training=TrainingConfig(
        output_dir="outputs/qwen3_moe_owt_104m_alf_adaptive_ema_variance",
        seed=42,
        max_steps=10_000,
        batch_size=128,
    ...
    wandb=WandbConfig(
        ...
        tags=["alf", "adaptive-ema", "adaptive-ema-variance", "qwen3-moe", "owt", "104m", "4h", "bpe32k"],
    ),
)
