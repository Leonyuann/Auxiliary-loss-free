"""324M Qwen3 MoE C4 per-expert adaptive bias-rate experiment with momentum."""

from alf.config import AlfConfig, DataConfig, EvalConfig, ExperimentConfig, ModelConfig, TrainingConfig, WandbConfig

config = ExperimentConfig(
    name="qwen3_moe_c4_300m_alf_adaptive_per_expert_momentum",
    model=ModelConfig(
    ...
    training=TrainingConfig(
        output_dir="outputs/qwen3_moe_c4_300m_alf_adaptive_per_expert_momentum",
        seed=42,
        max_steps=20_000,
        batch_size=128,
